...
public class HubShooterMath {
    ...
    public static final Distance DISTANCE_ABOVE_FUNNEL = Inches.of(5); // how high to clear the funnel
    ...
    public static LinearVelocity getShooterExitVelocity(AngularVelocity angularVelocity) {
        return MetersPerSecond.of(angularVelocity.in(RadiansPerSecond) * SHOOTER_WHEEL_RADIUS.in(Meters));
    }
