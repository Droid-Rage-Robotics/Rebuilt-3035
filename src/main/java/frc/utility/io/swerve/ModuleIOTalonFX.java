package frc.utility.io.swerve;

import static frc.utility.PhoenixUtil.tryUntilOk;
...
public abstract class ModuleIOTalonFX implements ModuleIO {
    ...
    protected ModuleIOTalonFX(
        ...
        driveTalon = new TalonFX(constants.DriveMotorId, DroidRageConstants.driveCanBus);
        turnTalon = new TalonFX(constants.SteerMotorId, DroidRageConstants.driveCanBus);
        cancoder = new CANcoder(constants.EncoderId, DroidRageConstants.driveCanBus);
        ...
        if (DroidRageConstants.currentMode == DroidRageConstants.Mode.SIM)
